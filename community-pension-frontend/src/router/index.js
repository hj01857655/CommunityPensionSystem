    ...
    //管理员首页
    {
        ...
        children: [
            ...
            },
            {
                ...
                meta: {title: '系统管理中心', icon: 'Setting', roles: ['admin', 'staff']},
                children: [
                    {
                        path: 'user',
                        name: 'UserManagement',
            ...
            //社区活动管理
            {
                ...
                meta: {title: '社区活动中心', icon: 'calendar', requiresAuth: true, roles: ['admin', 'staff']}, // 管理端活动管理模块
                children: [
                    {
                        path: 'list',
                        name: 'ActivityList',
            ...
            },
            {
                ...
                name: 'Services',
                meta: {title: '服务管理中心', icon: 'Service'},
                children: [
                    {
                        path: 'service',
                        name: 'ServiceItem',
            ...
            // 通知中心路由
            {
                ...
                component: () => import('@/views/back/notifications/index.vue'),
                meta: {title: '通知中心', icon: 'bell', requiresAuth: true, roles: ['admin', 'staff']}
            },
            // 通知详情路由
            {
                path: 'notifications/:id',
                name: 'AdminNotificationDetail',
                component: () => import('@/views/back/notifications/detail.vue'),
                meta: {
                    title: '通知详情',
                    icon: 'bell',
                    requiresAuth: true,
            ...
            // 消息中心路由
            {
                path: 'messages',
                name: 'AdminMessages',
                component: () => import('@/views/back/messages/index.vue'),
                meta: {title: '消息中心', icon: 'message', requiresAuth: true, roles: ['admin', 'staff']}
            },
            // 消息详情路由
            {
                path: 'messages/:id',
                name: 'AdminMessageDetail',
                component: () => import('@/views/back/messages/detail.vue'),
                meta: {
                    title: '消息详情',
                    icon: 'message',
                    requiresAuth: true,
                    roles: ['admin', 'staff'],
                    activeMenu: '/admin/messages'
                }
            },
            {
                path: 'error',
                ...
                meta: {
                    ...
                    icon: 'Error',
                    requiresAuth: true,
                    roles: ['admin', 'staff', 'elder', 'kin', 'guest']
                },
                children: [
                    {
                        path: '403',
...
router.beforeEach((to, from, next) => {
    ...
    if (isAdminRoute) {
        ...
        try {
            ...
            const userInfo = JSON.parse(sessionStorage.getItem('admin-user-info') || '{}');
            // 从userInfo中获取角色，如果没有则从sessionStorage单独获取
            const userRoles = userInfo?.roles || [sessionStorage.getItem('userRole')];
            
            // 如果路由没有定义角色要求，或者用户角色满足路由要求，则允许访问
